Shader "Editor/WireframeOnShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        LOD 200
        // NB: We add the blend moe in so that we analias our wireframe
        ...
        Pass
        {
            ...
            {
                v2f o;
                //We push the covertion to clipPos into the geom function as
                // the mesh vertex values for thr edge culling.
                //o.vertex = InityObjectToClipPos(v.vertex);
                o.vertex = v.vertex;
        ...
        // This applies the barycentric coordinates to each vertex in triangle.
        [maxvertexcount(3)]
        ...
        fixed4 frag(g2f i) : SV_Target
        {
            ...
            return fixed4C_WireframeColour.r, _WireframeColour.g, _WireframeColour.b, alpha);
        }
    }
    FallBack "Diffuse"
}
